...
import { fetchUserProfile, updateUserProfile, changePassword } from "../../services/profile-service";
import "./Profile.css";
...
const Profile = () => {
  ...
  const handlePasswordSubmit = async () => {
    let newErrors = { ...errors };
    if (!passwordData.oldPassword) newErrors.oldPassword = "Vui lòng nhập mật khẩu hiện tại.";
  ...
  if (error) {
    return (
      <div className="profile-error-message" style={{ padding: "20px", color: "red" }}>
        {error}
        {(error.includes("403") || error.includes("401") || error.includes("hết hạn") || error.includes("không hợp lệ")) && (
          <button
  ...
  if (loading) return <div className="profile-loading" style={{ padding: "20px" }}>Đang tải...</div>;
  if (!profile) return <div className="profile-error-message" style={{ padding: "20px", color: "red" }}>Không có dữ liệu hồ sơ!</div>;

  const avatarSrc = profile.avatar ? `http://localhost:5000${profile.avatar}` : "/assets/images/default-user.jpg";
          ...
          <div className="profile-actions">
            {isEditing ? (
              ...
              <>
                ...
                <button className="profile-change-password-button" onClick={() => setShowPasswordModal(true)}>
                  Change Password
                </button>
              </>
            )}
          ...
          <div className="profile-modal">
            <div className="profile-modal-content">
              ...
              <div className="profile-modal-section">
                ...
                />
                {errors.oldPassword && <p className="profile-error-message">{errors.oldPassword}</p>}
              </div>
              <div className="profile-modal-section">
              ...
              <div className="profile-modal-actions">
                <button className="profile-set-password-button" onClick={handlePasswordSubmit}>
                  Set Password
                </button>
                <button className="profile-cancel-modal-button" onClick={() => setShowPasswordModal(false)}>
                  Cancel
                </button>
              </div>
            </div>
